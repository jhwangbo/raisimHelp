...
sudo apt update && sudo apt install git terminator libeigen3-dev doxygen mercurial valgrind liburdfdom-dev curl minizip ffmpeg libyaml-cpp-dev && sudo snap install clion --classic && sudo snap install rider --classic
